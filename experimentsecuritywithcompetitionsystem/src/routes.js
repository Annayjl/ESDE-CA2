...
exports.appRoute = router => {
    ...
    router.post('/api/user/process-submission', function(req, res) {checkUserFn.getClientUserId, userController.processDesignSubmission});
    ...
    router.get('/api/user/process-search-user/:pagenumber/:search?',function(req, res) {checkUserFn.getClientUserId, userController.processGetUserData});
