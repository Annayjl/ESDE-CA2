...
var verifyFn = require('../helpers/verifyToken.js')
var sanitize = require('../helpers/sanitizer');

// 
exports.processDesignSubmission,sanitize.sanitizeData = (req, res, next) => {
...
exports.processGetUserData,verifyFn.verifyToken = async(req, res, next) => {
    ...
    try {
        ...
        res.status(403).json({Message:'Unauthorized call.'});
}
